            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:items-center md:gap-8">
                ...
                {PricingPlan.map((item, index)=>(
                    ...
                    <ul className="mt-6 space-y-2">
                        ...
                        <span className="text-gray-700"> {item.duration=="Monthly"?'100 Files':'2500 Files'} </span>
                        </li>
                        ...
                        <span className="text-gray-700"> {item.duration=="Monthly"?'2':'50'}GB of storage </span>
                        </li>
